#include "get_transaction_params.h"

#include "settings/settings.h"
#include "exception/except.h"

get_transaction_params::get_transaction_params(http_session_ptr session):
    base_network_handler(settings::server::address, session)
{
    m_duration.set_message(__func__);
}

get_transaction_params::~get_transaction_params()
{
}

bool get_transaction_params::prepare_params()
{
    BGN_TRY
    {
        ...
        m_writer.add("method", "transaction.params");
